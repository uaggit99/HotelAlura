...
public class Exito extends JDialog {
	...
	public Exito() {
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setBounds(155, 11, 100, 100);
		...
		}
		{
			...
			lblNewLabel_1.setBounds(42, 146, 322, 21);
		...
		}
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.setFont(new Font("Yu Gothic UI", Font.BOLD, 16));
			...
			}
			{
				...
				cancelButton.setFont(new Font("Yu Gothic UI", Font.BOLD, 16));

...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnNewButton = new JButton("R e g i s t r a r s e");
		...
		btnNewButton.setFont(new Font("Dubai Light", Font.BOLD, 16));
		btnNewButton.setForeground(Color.WHITE);
		btnNewButton.setBounds(246, 431, 185, 44);
	...
	private void consultaUsuario() {
		...
		Usuarios usuario = new Usuarios(nombre, clave);
		UsuarioController controller = new UsuarioController();
		List dato= controller.validacion(nombre, clave);		
		if(dato!= null) {
	...
	private void Login() {
		...
		// String datos[]= {nombre,clave,validar};

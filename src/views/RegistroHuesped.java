...
public class RegistroHuesped extends JFrame {
	...
	int xMouse, yMouse;
	protected static GraphicsConfiguration idReserva;
	...
	public RegistroHuesped(int idReserva) {
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			private void guardarHuesped() {
				...
				Huespedes huesped= new Huespedes(nombre,apellidos,java.sql.Date.valueOf(fecha),nacionalidad,
					telefono,idReserva);
			HuespedesController Controller =  new HuespedesController();
			Controller.guardar(huesped);
			Exito exito =new Exito();
			exito.setVisible(true);
			dispose();
			//	JOptionPane.showMessageDialog(contentPane, "!! Huesped guardado con exito !! id: " + huesped.getId());
